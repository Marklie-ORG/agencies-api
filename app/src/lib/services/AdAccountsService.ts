...
// import { Database } from "markly-ts-core";
...
const businesses = {
	"data": [
		{
			...
			"client_ad_accounts": {
				"data": [
					...
					{
						"id": "act_2436054433220139",
						"name": "Vdvelde.com",
						"account_status": 1,
						"business": {
							"id": "2232374173717941",
							"name": "GreenGifts & Van der Velde Waterplanten"
						}
					},
					{
				...
				"paging": {
					"cursors": {
						...
						"after": "QVFIUml4RHc1bTVLZAXM3SkNuVXR4Wk1iUmQ0R2EyNW1vOEFYTGxYM3JfT3htUV96TXl4bldMUFNYRUszcEEwY0pyRzJHZATg4ZAFFZAcjRMV3JPbkk2ZA0kwRnl3"
					},
					"next": "https://graph.facebook.com/v22.0/2962000427377693/client_ad_accounts?access_token=EAASERizF7PoBO4XOexnqEomdSKONuuZBCBWryqmFAE0kYALxwEN2gvTxlJzZChNHOsl3ZA0klnkSD7ajPXtAuMWZB5jOymfNud2Vq7tPgwYTbt5xGz1ACNZBvqXxQBtuqAuiWgBiFgC3oE5BrAViAxfYTHiZBZCyWe0EfZClhNz37BzB4ZAZCpn8AIJGyi&fields=id%2Cname%2Caccount_status%2Cbusiness&limit=25&after=QVFIUml4RHc1bTVLZAXM3SkNuVXR4Wk1iUmQ0R2EyNW1vOEFYTGxYM3JfT3htUV96TXl4bldMUFNYRUszcEEwY0pyRzJHZATg4ZAFFZAcjRMV3JPbkk2ZA0kwRnl3"
				}
			}
		},
		{
			...
			"owned_ad_accounts": {
				...
				"paging": {
					"cursors": {
						"before": "QVFIUmYwQVdvZAzZAKdnhlZAnBnSzVULVhHNmJJX0VxS2hqTU5XLWpGaG1HV1JWTm5TblR3eEV6RWp2UkMyRHF0NmROcE9rMzlHN092MDM0ZAy1xUDRfVEF0bm13",
						"after": "QVFIUmYwQVdvZAzZAKdnhlZAnBnSzVULVhHNmJJX0VxS2hqTU5XLWpGaG1HV1JWTm5TblR3eEV6RWp2UkMyRHF0NmROcE9rMzlHN092MDM0ZAy1xUDRfVEF0bm13"
					}
				}
			}
		},
		{
			...
			"owned_ad_accounts": {
				...
				"paging": {
					...
					"next": "https://graph.facebook.com/v22.0/2173853606276080/owned_ad_accounts?access_token=EAASERizF7PoBO4XOexnqEomdSKONuuZBCBWryqmFAE0kYALxwEN2gvTxlJzZChNHOsl3ZA0klnkSD7ajPXtAuMWZB5jOymfNud2Vq7tPgwYTbt5xGz1ACNZBvqXxQBtuqAuiWgBiFgC3oE5BrAViAxfYTHiZBZCyWe0EfZClhNz37BzB4ZAZCpn8AIJGyi&fields=id%2Cname%2Caccount_status%2Cbusiness&limit=25&after=QVFIUmJUU0J2TF9lcW9IU0NzNEJOSzBvZAGd2eGpnY3BuazA3Ym53NEdCLXFrTEJvZAnl6bU1zc19DOWxOR1pBWFk4MEdzNGU4WFdOSzBhMENJQy1ldG45N2ZAn"
				}
			},
			"client_ad_accounts": {
				"data": [
			...
			"client_ad_accounts": {
				...
				"paging": {
					"cursors": {
						...
						"after": "QVFIUllwQU41NkFyU2FObnpEZAW9sTmdua3pMT1pnZA2V1WWZADbkFjZAngyT3FjOXpFb3NqVDl2Q0NqdnpBSVpYcEhDYzZAQaF9weW5oSE94eWU4V2Rrbm1qTXNB"
					}
				}
			}
		},
			...
			"client_ad_accounts": {
				"data": [
					...
					},
					{
						...
						"business": {
							"id": "1942341849143261",
							"name": "Dexter's Natural Petfoods"
						}
					},
					{
	...
	"paging": {
		...
		"next": "https://graph.facebook.com/v22.0/9665397933490694/businesses?fields=id,name,owned_ad_accounts%7Bid,name,account_status,business%7D,client_ad_accounts%7Bid,name,account_status,business%7D&access_token=EAASERizF7PoBO4XOexnqEomdSKONuuZBCBWryqmFAE0kYALxwEN2gvTxlJzZChNHOsl3ZA0klnkSD7ajPXtAuMWZB5jOymfNud2Vq7tPgwYTbt5xGz1ACNZBvqXxQBtuqAuiWgBiFgC3oE5BrAViAxfYTHiZBZCyWe0EfZClhNz37BzB4ZAZCpn8AIJGyi&limit=25&after=QVFIUmdSa1EyWVh6dDd5QXI5Nm10YWFlRG12TFRaNW4tZA1pNVVV0ZAThPWTNCWU1ZAWGEzYTZAQb3RTRkpVYzNpUEFncURoeVQ0ZA0VORkJ3R1NfelJDVDRBQ213"
	}
}

const adAccountsResponse = {
	"data": [
		{
			"id": "act_172594753",
			"name": "Trendjuwelier",
		...
		{
			"id": "act_4187932754551680",
			"name": "Patricia van Etten",
			"account_status": 1,
			"currency": "EUR",
			"timezone_name": "Europe/Amsterdam"
		},
	...
	"paging": {
		"cursors": {
			"before": "NjAwMjYzNzkzNTU1OQZDZD",
			"after": "MTIwMjE2Njk0OTAzNDcwNTky"
		}
	}
}
adAccountsResponse
...
export class AdAccountsService {
    ...
    async getAvailableAdAccounts(): Promise<any> {
      ...
      let businessesHierarchy = await extractAccountHierarchy(businessesResponse as any);
      ...
      for (const business of businessesHierarchy) {
        for (let adAccount of (business as any).ad_accounts) { // if ad account not present in ad accounts list -> remove it from business
          if (!adAccounts.includes(adAccount.id)) {
            (business as any).ad_accounts = (business as any).ad_accounts.filter((account: any) => account.id !== adAccount.id);
          }
        }
        if ((business as any).ad_accounts.length === 0) { // if business has no ad accounts -> remove it from hierarchy
          businessesHierarchy = businessesHierarchy.filter((business1: any) => business1.id !== (business as any).id);
        }
      }
